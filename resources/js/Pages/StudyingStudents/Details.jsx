...
import ResultCardContent from "./../../Components/ResultCards/ResultCardContent";
                ...
                <div className="academic-details-wrapper__header">
                    <div className="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h2 className="f-14 fw-600 mb-1">
                                Student John Doe
                            </h2>
                        </div>
                        <div className="d-flex justify-content-between align-items-center">
                            <div>
                                <p className="f-12 color-abbey mb-5-px">
                                    Scholarship
                                </p>
                                <h2 className="f-14 fw-500">
                                    Sibling Concession
                                </h2>
                            </div>
